...
import com.hsj.blogwaja.dao.BlogConfigMapper;
import com.hsj.blogwaja.entity.BlogConfig;
import com.hsj.blogwaja.service.ConfigService;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String yourEmail = "huang_shi_jie@qq.com";
    public static final String yourName = "waja";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "浙ICP备 xxxxxx-x号";
    public static final String footerCopyRight = "@2019 waja";
